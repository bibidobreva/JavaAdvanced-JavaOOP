...
public class Tire {
    ...
    public Tire(double tire1Pressure, int tire1Age,double tire2Pressure, int tire2Age,double tire3Pressure, int tire3Age,double tire4Pressure, int tire4Age){
        ...
        this.tire3Pressure = tire1Pressure;
        this.tire3Age = tire3Age;
        this.tire4Pressure = tire4Pressure;
        this.tire4Age = tire4Age;
    }

    public boolean tyrePressureUnder1(){
        if(this.tire1Pressure<1||this.tire2Pressure<1||this.tire3Pressure<1||this.tire4Pressure<1) return true;
        else return false;
    }
}
